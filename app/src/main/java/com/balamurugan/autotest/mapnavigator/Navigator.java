package com.balamurugan.autotest.mapnavigator;
...
/*	public Navigator(GoogleMap map, LatLng startLocation, LatLng endLocation){
	...
	public Navigator(GoogleMap map, String source, String destination){
		this.source = source;
	...
	private class PathCreator extends AsyncTask<Void,Void,Directions>{
		...
		protected Directions doInBackground(Void... params) {
			...
			String url = "https://maps.googleapis.com/maps/api/directions/json?origin="
					+ source + "&destination=" + destination + "&key=AIzaSyDdHXhP8W4V2w-OUOwUOIsoYFefYExTRSY";
